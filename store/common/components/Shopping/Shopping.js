class Shopping {
                ...
                <table>
                    ...
                    <tr>
                      ...
                      <tr>
                        ...
                        ">
                        <i class="fa fa-whatsapp" style="font-size:32px;color:green;margin-top:-10px;"></i> Связаться по WhatsApp</a>
                        </td>
                      </tr>
                    </tr>
                </table>
  ...
  btn_sum(product_id) {
    ...
    var new_price = Number(edited_product[0]["quantity"]) * Number(edited_product[0]["price"]);
  ...
  countNewOrderPrice(){
    ...
    var tags_with_prices = document.querySelectorAll(".shopping-element__price");
    var sumPrice = 0;
